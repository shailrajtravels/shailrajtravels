      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-brand-blue-deep mb-6">Areas We Serve</h2>
            <p className="text-slate-600 mb-8 text-lg">While our physical headquarters is in Pune, our fleet operates across major pilgrimage hubs in India, ensuring you get local expertise wherever your faith takes you.</p>
          ...
          <div className="flex-1 w-full bg-white p-2 rounded-3xl shadow-sm border border-slate-100">
            ...
            <div className="aspect-[4/3] bg-brand-blue/5 rounded-2xl flex items-center justify-center relative overflow-hidden">
               ...
               {/* Decorative map dots */}
               <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(#1E3A8A 2px, transparent 2px)', backgroundSize: '24px 24px' }}></div>
            </div>
          </div>
        </div>
      </div>
