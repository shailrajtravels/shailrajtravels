...
export const resources: Resource[] = [
  {
    ...
    metaDescription: 'Complete guide for Ujjain Mahakaleshwar darshan. Learn about Bhasma Aarti booking, VIP passes, and temple timings.',
    ...
    `,
    faqs: [
      { question: "What is the dress code for Bhasma Aarti?", answer: "Men must wear only a dhoti (unstitched cloth). Women must wear a saree. Salwar suits or jeans are strictly not allowed for the Aarti." },
      { question: "Can we get VIP Darshan at Mahakaleshwar?", answer: "Yes, a ₹250 VIP Darshan pass is available from the temple counters which significantly reduces waiting time." }
    ],
  ...
  },
  {
    ...
    metaDescription: 'What to pack and know before traveling to Gujarat for the Dwarka and Somnath Jyotirlinga tour.',
    ...
    `,
    faqs: [
      { question: "Are phones allowed in Somnath Temple?", answer: "No, mobile phones and all electronics are strictly banned inside the Somnath temple premises. You must deposit them in lockers." },
      { question: "Do we need to walk a lot in Dwarka?", answer: "Yes, the Dwarkadhish temple involves walking up 56 steps (Swarg Dwar) and walking around the temple complex." }
    ],
  ...
  },
  {
    ...
    metaDescription: 'Complete guide to the Saptashrungi Funicular Ropeway at Vani, Nashik. Timings, ticket prices, and accessibility.',
    category: 'Route Maps',
    content: `
    ...
    `,
    faqs: [
      { question: "Can wheelchairs go into the ropeway?", answer: "Yes, the funicular trolley is wheelchair accessible to a certain point, but some walking/assistance is required inside the main temple area." },
      { question: "Is parking available near the ropeway?", answer: "Yes, there is a large parking area near the base station of the funicular trolley." }
    ],
  ...
  },
  {
    ...
    metaDescription: 'Essential rules, dress codes, and Mahaprasad guide for the Jagannath Puri temple in Odisha.',
    category: 'Temple Guides',
    content: `
    ...
    `,
    faqs: [
      { question: "What is the dress code for Jagannath Temple?", answer: "Traditional Indian attire is mandatory. Men should wear dhoti/kurta or formal trousers. Women should wear sarees or salwar kameez. Jeans and shorts are not allowed." },
      { question: "Can we carry leather items?", answer: "No, leather belts, wallets, and bags are prohibited inside the temple." }
    ],
  ...
  },
  {
    ...
    metaDescription: 'What to pack for your 2-day Ashtavinayak yatra from Pune. Essential items for a comfortable bus journey.',
    category: 'Travel Checklists',
    content: `
    ...
    `,
    faqs: [
      { question: "Do we need warm clothes for Ashtavinayak?", answer: "If traveling between November and February, carrying a light sweater is recommended, especially for the early morning visits to Lenyadri and Ozar." },
      { question: "Can we carry our own food?", answer: "Yes, carrying dry snacks is perfectly fine for the bus journey, though all main meals are provided in our package." }
    ],
