...
export const factPages: FactPage[] = [
  {
    ...
    metaDescription: 'Detailed statistics, temple distances, and historical facts about the Ashtavinayak Yatra in Maharashtra.',
    keyFacts: [
  ...
  },
  {
    ...
    metaDescription: 'Fascinating facts, historical timeline, and visitor statistics of the Shirdi Sai Baba Temple in Maharashtra.',
    keyFacts: [
  ...
  },
  {
    ...
    metaDescription: 'Comprehensive facts, locations, and geographical data of the 12 Jyotirlinga temples of Lord Shiva across India.',
    keyFacts: [
