...
import { generateArticleSchema, generateBreadcrumbSchema, generateFAQSchema } from '../../lib/blog-schema';
              ...
              {post.relatedTourSlugs && post.relatedTourSlugs.length > 0 ? (
                <div className="space-y-3 relative z-10">
                  {post.relatedTourSlugs.slice(0, 2).map((tourSlug, idx) => {
                    const tour = require('../../data/tours.en').tours.find((t: any) => t.slug === tourSlug);
                    return (
